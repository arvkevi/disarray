...
class TestDisarray(unittest.TestCase):
    ...
    def test_false_discovery_rate(self):
        self.assertAlmostEqual(self.df_binary.da.false_discovery_rate.loc[1], 0.25, 2)
    ...
    def test_false_negative_rate(self):
        self.assertAlmostEqual(self.df_binary.da.false_negative_rate.loc[1], 0.25, 2)
    ...
    def test_false_positive_rate(self):
        self.assertAlmostEqual(self.df_binary.da.false_positive_rate.loc[1], 0.167, 2)
    ...
    def test_negative_predictive_value(self):
        self.assertAlmostEqual(self.df_binary.da.negative_predictive_value.loc[1], 0.83, 2)
    ...
    def test_positive_predictive_value(self):
        self.assertAlmostEqual(self.df_binary.da.positive_predictive_value.loc[1], 0.75, 2)
    ...
    def test_specificity(self):
        self.assertAlmostEqual(self.df_binary.da.specificity.loc[1], 0.83, 2)
    ...
    def test_true_negative_rate(self):
        self.assertAlmostEqual(self.df_binary.da.true_negative_rate.loc[1], 0.83, 2)
    ...
    def test_true_positive_rate(self):
        self.assertAlmostEqual(self.df_binary.da.true_positive_rate.loc[1], 0.75, 2)
